<x-filament-panels::page>
    <div class="py-3">
        <div class="relative w-full">
            ...
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari nomor neraca, faskes..."
    ...
    <div class="ruang-obat-filter-row">
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" @click.away="open = false" x-cloak class="ruang-obat-filter-dropdown">
                <div class="space-y-3">
                    <div>
                        <label class="ruang-obat-filter-label">Tahun</label>
                        <select wire:model.live="filterTahun" class="ruang-obat-filter-select">
