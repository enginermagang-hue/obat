...
return new class extends Migration
{
    ...
    public function down(): void
    {
        if (DB::getDriverName() === 'sqlite') {
            ...
            DB::statement('INSERT INTO pengaturan_laporan_new SELECT id, fasilitas_id, grup, key, value, created_at, updated_at FROM pengaturan_laporan WHERE grup != \'format_nomor\'');
            Schema::disableForeignKeyConstraints();
            Schema::drop('pengaturan_laporan');
            Schema::rename('pengaturan_laporan_new', 'pengaturan_laporan');
            Schema::enableForeignKeyConstraints();
